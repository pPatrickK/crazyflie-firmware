...
void addQ(
	double dt, struct quat q,
	struct vec ew, struct vec ea,
	struct vec n_a, struct vec n_ba,
	struct vec n_w, struct vec n_bw,
	float Q[EKF_N][EKF_N])
{
	double q1 = q.w, q2 = q.v.x, q3 = q.v.y, q4 = q.v.z;
	double ew1=ew.x, ew2=ew.y, ew3=ew.z;
	double ea1=ea.x, ea2=ea.y, ea3=ea.z;
	double n_a1=n_a.x, n_a2=n_a.y, n_a3=n_a.z;
	double n_ba1=n_ba.x, n_ba2=n_ba.y, n_ba3=n_ba.z;
	double n_w1=n_w.x, n_w2=n_w.y, n_w3=n_w.z;
	double n_bw1=n_bw.x, n_bw2=n_bw.y, n_bw3=n_bw.z;
	...
	Q[0][0] += dt*t343*t347*t361*(1.0/3.0)+dt*t343*t354*t359*(1.0/3.0)+dt*t343*t355*t360*(1.0/3.0);
	Q[0][1] += t375-dt*t343*t345*t355*(t358-q3*q4*2.0)*(1.0/3.0)-dt*t343*t344*t354*t367*(1.0/3.0);
	Q[0][2] += t402;
	Q[0][3] += t419;
	Q[0][4] += t420;
	Q[0][5] += t408;
	Q[0][6] += t564;
	Q[0][8] += t615;
	Q[0][12] += dt*t343*t346*t398*(-1.0/6.0);
	Q[0][13] += t660;
	Q[0][14] += dt*t343*t345*t400*(-1.0/6.0);
	Q[1][0] += t375-dt*t343*t344*t354*t367*(1.0/3.0)-dt*t343*t345*t355*t376*(1.0/3.0);
	Q[1][1] += dt*t343*t347*t378*(1.0/3.0)+dt*t343*t355*t379*(1.0/3.0)+dt*t343*t354*t385*(1.0/3.0);
	Q[1][2] += t404;
	Q[1][3] += t377+t455-t343*t344*t354*t367*(1.0/2.0)-t343*t345*t355*t376*(1.0/2.0)-dt*t343*t362*t371*t381*(1.0/6.0)-dt*t343*t362*t373*t388*(1.0/6.0);
	Q[1][4] += t462;
	Q[1][5] += t412;
	Q[1][6] += dt*t343*t374*t384*(-1.0/6.0);
	Q[1][7] += t581;
	Q[1][8] += t616;
	Q[1][12] += dt*t343*t366*t398*(-1.0/6.0);
	Q[1][13] += dt*t343*t367*t399*(-1.0/6.0);
	Q[1][14] += t662;
	Q[2][0] += t402;
	Q[2][1] += t404;
	Q[2][2] += dt*t343*t347*t413*(1.0/3.0)+dt*t343*t354*t414*(1.0/3.0)+dt*t343*t355*t415*(1.0/3.0);
	Q[2][3] += t408;
	Q[2][4] += t412;
	Q[2][5] += t510;
	Q[2][6] += t565;
	Q[2][7] += dt*t343*t373*t397*(-1.0/6.0);
	Q[2][8] += t617;
	Q[2][12] += t658;
	Q[2][13] += dt*t343*t372*t399*(-1.0/6.0);
	Q[2][14] += dt*t343*t370*t400*(-1.0/6.0);
	Q[3][0] += t419;
	Q[3][1] += t420;
	Q[3][2] += t408;
	Q[3][3] += t374*(t428+t343*t362*t425+dt*t343*(t362*(t448+t449-t362*t432)+t425*t425)*(1.0/3.0))+t373*(t428-t434+dt*t343*(t365*t429-t362*t437)*(1.0/3.0))+t371*(t428+t434+dt*t343*(t365*t429-t362*(t433+t442-ew2*ew3*t362))*(1.0/3.0))+dt*t347*t361+dt*t354*t359+dt*t355*t360+dt*t343*t359*t399*(1.0/3.0)+dt*t343*t361*t398*(1.0/3.0)+dt*t343*t360*t400*(1.0/3.0);
	Q[3][4] += t475+t476-dt*t344*t354*t367-dt*t345*t355*t376-dt*t343*t344*t367*t399*(1.0/3.0)-dt*t343*t345*t376*t400*(1.0/3.0);
	Q[3][5] += t522+t534+t535+t536-t373*(t440+t515-dt*t343*(t513+t514+t362*(t490+t491-t390*t432)*(1.0/2.0))*(1.0/3.0))-dt*t346*t347*t369-dt*t344*t354*t372-dt*t343*t346*t369*t398*(1.0/3.0)-dt*t343*t344*t372*t399*(1.0/3.0);
	Q[3][6] += t573;
	Q[3][8] += -t371*(t451+t452-dt*t343*(t442+t582-ew2*ew3*t362*(1.0/2.0))*(1.0/3.0))-t374*t622+t373*(t452-dt*t343*t585*(1.0/3.0));
	Q[3][9] += dt*t343*t362*t502*(-1.0/6.0);
	Q[3][11] += dt*t343*t362*t503*(-1.0/6.0);
	Q[3][12] += t343*t346*t398*(-1.0/2.0);
	Q[3][13] += t661;
	Q[3][14] += t343*t345*t400*(-1.0/2.0);
	Q[4][0] += t377-t453-t454+t455-dt*t343*t362*t371*t381*(1.0/6.0)-dt*t343*t362*t373*t388*(1.0/6.0);
	Q[4][1] += t462;
	Q[4][2] += t412;
	Q[4][3] += t475+t476-t374*(t343*(t384*t425-t362*t473)*(1.0/2.0)-dt*t343*(t362*t483*(1.0/2.0)-t384*t474*(1.0/2.0)+t425*t473)*(1.0/3.0)+dt*t362*t384)+t371*(t470+dt*t362*t381+dt*t343*(t362*t485*(1.0/2.0)-t381*t466*(1.0/2.0)+t362*t388*t429)*(1.0/3.0))+t373*(-t470+dt*t362*t388+dt*t343*(t388*t437*(-1.0/2.0)+t362*t478*(1.0/2.0)+t362*t381*t429)*(1.0/3.0))-dt*t344*t354*t367-dt*t345*t355*t376-dt*t343*t344*t367*t399*(1.0/3.0)-dt*t343*t345*t376*t400*(1.0/3.0);
	Q[4][4] += -t374*(-dt*t459+dt*t343*(t384*t483-t480*t480)*(1.0/3.0)+t343*t384*t473)+t373*(dt*t461+dt*t343*(t388*t478+t429*t458)*(1.0/3.0)-ew1*t343*t381*t388)+t371*(dt*t458+dt*t343*(t381*t485+t429*t461)*(1.0/3.0)+ew1*t343*t381*t388)+dt*t347*t378+dt*t355*t379+dt*t354*t385+dt*t343*t378*t398*(1.0/3.0)+dt*t343*t385*t399*(1.0/3.0)+dt*t343*t379*t400*(1.0/3.0);
	Q[4][5] += t560;
	Q[4][6] += -t374*(-dt*t384+t343*t473*(1.0/2.0)+dt*t343*(t471+ew1*ew2*t388*(1.0/2.0)+ew1*ew3*t381*(1.0/2.0))*(1.0/3.0))+dt*t343*t371*t381*t432*(1.0/6.0)+dt*t343*t373*t388*t432*(1.0/6.0);
	Q[4][7] += t599;
	Q[4][8] += -t374*t631-t371*t635-t373*(t626-ew1*t343*t388*(1.0/2.0));
	Q[4][9] += dt*t343*t384*t502*(1.0/6.0);
	Q[4][10] += dt*t343*t388*t563*(-1.0/6.0);
	Q[4][11] += dt*t343*t381*t503*(-1.0/6.0);
	Q[4][12] += t343*t366*t398*(-1.0/2.0);
	Q[4][13] += t343*t367*t399*(-1.0/2.0);
	Q[4][14] += t663;
	Q[5][0] += t408;
	Q[5][1] += t412;
	Q[5][2] += t510;
	Q[5][3] += t522+t534+t535+t536-t373*(t440+t515-dt*t343*(t513+t514+t362*t512*(1.0/2.0))*(1.0/3.0))-dt*t346*t347*t369-dt*t344*t354*t372-dt*t343*t346*t369*t398*(1.0/3.0)-dt*t343*t344*t372*t399*(1.0/3.0);
	Q[5][4] += t560;
	Q[5][5] += -t371*(t561-dt*t509+dt*t343*(t394*t489-t429*t506)*(1.0/3.0))+t373*(t561+dt*t506-dt*t343*(t397*t512-t429*t509)*(1.0/3.0))+t374*(dt*t507-dt*t343*(t390*t497-t447*t447)*(1.0/3.0)+t343*t390*t447)+dt*t347*t413+dt*t354*t414+dt*t355*t415+dt*t343*t398*t413*(1.0/3.0)+dt*t343*t399*t414*(1.0/3.0)+dt*t343*t400*t415*(1.0/3.0);
	Q[5][6] += t580;
	Q[5][7] += t608+t371*(dt*t343*(t600-ew2*ew3*t394*(1.0/2.0))*(1.0/3.0)-ew1*t343*t394*(1.0/2.0))+t373*(t602+t610-dt*t343*(t490+t601-t390*t432*(1.0/2.0))*(1.0/3.0));
	Q[5][8] += t647-t374*t641-t373*(t562+dt*t343*(t642-ew2*ew3*t397*(1.0/2.0))*(1.0/3.0));
	Q[5][9] += dt*t343*t390*t502*(-1.0/6.0);
	Q[5][10] += t656;
	Q[5][11] += dt*t343*t394*t503*(-1.0/6.0);
	Q[5][12] += t659;
	Q[5][13] += t343*t372*t399*(-1.0/2.0);
	Q[5][14] += t343*t370*t400*(-1.0/2.0);
	Q[6][0] += t564;
	Q[6][2] += t565;
	Q[6][3] += t573;
	Q[6][5] += t580;
	Q[6][6] += t374*(dt-dt*t343*t432*(1.0/3.0))+dt*t343*t502*(1.0/3.0);
	Q[6][8] += t652;
	Q[6][9] += t343*t502*(-1.0/2.0);
	Q[7][0] += dt*t343*t362*t373*(1.0/6.0);
	Q[7][1] += t581;
	Q[7][2] += dt*t343*t373*t397*(-1.0/6.0);
	Q[7][3] += -t371*(t452+t623)-t374*(dt*t343*(t566-ew3*t425)*(1.0/3.0)-ew3*t343*t362*(1.0/2.0))+t373*(-t451+t452+dt*t343*(t436+t582-t583)*(1.0/3.0));
	Q[7][4] += t599;
	Q[7][5] += t608+t373*(t602+t610-dt*t343*(t490+t601-t609)*(1.0/3.0))-t371*(t602-dt*t343*(t600-t601)*(1.0/3.0));
	Q[7][6] += -t374*(ew3*t343*(1.0/2.0)-dt*ew1*ew2*t343*(1.0/6.0))-dt*t343*t373*t613*(1.0/3.0);
	Q[7][7] += t373*(dt-dt*t343*t435*(1.0/3.0))+dt*t343*t563*(1.0/3.0)+dt*t343*t371*t429*(1.0/3.0)+dt*t343*t374*t431*(1.0/3.0);
	Q[7][8] += t655-t373*(t614-dt*ew2*ew3*t343*(1.0/6.0))-dt*ew2*ew3*t343*t374*(1.0/3.0);
	Q[7][9] += dt*ew3*t343*t502*(1.0/6.0);
	Q[7][10] += t343*t563*(-1.0/2.0);
	Q[7][11] += dt*ew1*t343*t503*(-1.0/6.0);
	Q[8][0] += t615;
	Q[8][1] += t616;
	Q[8][2] += t617;
	Q[8][3] += -t374*t622-t371*(t451+t452-dt*t343*(t442+t582-t583)*(1.0/3.0))+t373*(t452-t623);
	Q[8][4] += -t374*t631-t371*t635-t373*(t626-t627);
	Q[8][5] += t647-t374*t641-t373*(t562+dt*t343*(t642-t643)*(1.0/3.0));
	Q[8][6] += t652;
	Q[8][7] += t655-t373*(t614-t653)-dt*ew2*ew3*t343*t374*(1.0/3.0);
	Q[8][8] += t371*(dt-dt*t343*t441*(1.0/3.0))+dt*t343*t503*(1.0/3.0)+dt*t343*t373*t429*(1.0/3.0)+dt*t343*t374*t430*(1.0/3.0);
	Q[8][9] += dt*ew2*t343*t502*(-1.0/6.0);
	Q[8][10] += t657;
	Q[8][11] += t343*t503*(-1.0/2.0);
	Q[9][3] += dt*t343*t362*t502*(-1.0/6.0);
	Q[9][5] += dt*t343*t390*t502*(-1.0/6.0);
	Q[9][6] += t343*t502*(-1.0/2.0);
	Q[9][8] += dt*ew2*t343*t502*(-1.0/6.0);
	Q[9][9] += dt*t502;
	Q[10][3] += dt*t343*t362*t563*(-1.0/6.0);
	Q[10][4] += dt*t343*t388*t563*(-1.0/6.0);
	Q[10][5] += t656;
	Q[10][7] += t343*t563*(-1.0/2.0);
	Q[10][8] += t657;
	Q[10][10] += dt*t563;
	Q[11][3] += dt*t343*t362*t503*(-1.0/6.0);
	Q[11][4] += dt*t343*t381*t503*(-1.0/6.0);
	Q[11][5] += dt*t343*t394*t503*(-1.0/6.0);
	Q[11][7] += dt*ew1*t343*t503*(-1.0/6.0);
	Q[11][8] += t343*t503*(-1.0/2.0);
	Q[11][11] += dt*t503;
	Q[12][0] += dt*t343*t346*t398*(-1.0/6.0);
	Q[12][1] += dt*t343*t366*t398*(-1.0/6.0);
	Q[12][2] += t658;
	Q[12][3] += t343*t346*t398*(-1.0/2.0);
	Q[12][4] += t343*t366*t398*(-1.0/2.0);
	Q[12][5] += t659;
	Q[12][12] += dt*t398;
	Q[13][0] += t660;
	Q[13][1] += dt*t343*t367*t399*(-1.0/6.0);
	Q[13][2] += dt*t343*t372*t399*(-1.0/6.0);
	Q[13][3] += t661;
	Q[13][4] += t343*t367*t399*(-1.0/2.0);
	Q[13][5] += t343*t372*t399*(-1.0/2.0);
	Q[13][13] += dt*t399;
	Q[14][0] += dt*t343*t345*t400*(-1.0/6.0);
	Q[14][1] += t662;
	Q[14][2] += dt*t343*t370*t400*(-1.0/6.0);
	Q[14][3] += t343*t345*t400*(-1.0/2.0);
	Q[14][4] += t663;
	Q[14][5] += t343*t370*t400*(-1.0/2.0);
	Q[14][14] += dt*t400;
}
